...
Scenario: get .map file of application
      ...
      When I invoke a GET to getMapFile and applicationIdentifier "1" to get .map file      
      
Scenario: get .map file of application without stored .map
     When I invoke a GET to getMapFile and applicationIdentifier "98761205478" to get .map file
