...
Scenario: get a metadata of map  
	 Given I have a map with an APPLICATIONID "1" and metadata osmChecksum "osmChecksum", routingChecksum "routingChecksum", minLat "-1.0", minLon "-2.0", maxLat "-3.0" and maxLon "-4.0"
