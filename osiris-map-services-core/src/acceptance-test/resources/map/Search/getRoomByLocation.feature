...
Scenario: get room with a valid location 
	  Given I have a map with a Room and appId "1"
      When I invoke a GET to getRoomByLocation with appId "1", longitude "-0.3343816", latitude "39.4771828" and floor 0     
      Then returned room is "Experimental"

Scenario: get room with a invalid location        
      Given I have a map with appId "1"
      When I invoke a GET to getRoomByLocation with appId "1", longitude "39.4771567", latitude "-0.3344323" and floor 0
