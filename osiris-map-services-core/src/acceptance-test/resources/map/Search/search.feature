...
Scenario: get features within box of features
    ...
    When I invoke a getFeatureByQuery to feature and query "{geometry: {$geoWithin: {$geometry: {type: 'Polygon', coordinates: [[ [-1,-1], [0,50], [50,50], [50,0], [-1,-1] ]] }}}}" and applicationIdentifier "2"    
...
Scenario: get features within box of map
    ...
    When I invoke a getFeatureByQuery to map and query "{geometry: {$geoWithin: {$geometry: {type: 'Polygon', coordinates: [ [ [ -4.658203125 , 39.926588421909436] , [ -4.658203125 , 40.83043687764923] , [ -2.39501953125 , 40.83043687764923] , [ -2.39501953125 , 39.926588421909436] , [ -4.658203125 , 39.926588421909436]]] }}}}" and applicationIdentifier "2"    
...
Scenario: get features within box of all
    ...
    When I invoke a getFeatureByQuery to all and query "{geometry: {$geoWithin: {$geometry: {type: 'Polygon', coordinates: [[ [-5,-5], [-5,50], [50,50], [50,-5], [-5,-5] ]] }}}}" and applicationIdentifier "2"    
