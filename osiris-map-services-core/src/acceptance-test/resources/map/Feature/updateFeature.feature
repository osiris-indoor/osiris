...
Scenario: update a feature of type point in application
	  Given I store a feature of type point with latitude 50, longitude 140, altitude 160 and jsonObject with key "place" and value "burger" and applicationIdentifier "1"
 	  When I invoke a PUT to updateFeature of type point and idFeature with latitude 59, longitude 149, altitude 169 and jsonObject with key "place" and value "burger"      
...
Scenario: update a feature of type lineString in application
      ...
      When I invoke a PUT to updateFeature of type lineString and idFeature with latitude 59, longitude 149, altitude 169, latitude 35, longitude 22, altitude 24 and jsonObject with key "place" and value "burger"      
...
Scenario: update a feature with no valid geometry
	  Given I store a feature of type point with latitude 50, longitude 140, altitude 160 and jsonObject with key "place" and value "burger" and applicationIdentifier "1"
      When I invoke a PUT to updateFeature of type errorGeometry with key "place" and value "burger"
...
Scenario: check latitude is between -90 and 90
	  ...
	  When I invoke a PUT to updateFeature of type point and idFeature with latitude 128, longitude 20, altitude 168 and jsonObject with key "place" and value "burger"
...
Scenario: check longitude is between -180 and 180
      ...
      When I invoke a PUT to updateFeature of type point and idFeature with latitude 50, longitude 200, altitude 160 and jsonObject with key "place" and value "burger"
      Then I receive a LongitudeValueException

@deleteFeatures      
Scenario: idFeature not found      
	  When I invoke a PUT to updateFeature of type point with idFeature -1, latitude 50, longitude 140, altitude 160 and jsonObject with key "place" and value "burger"
